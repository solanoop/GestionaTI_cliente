                    ...
                    <div class="container">
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="password" class="form-control" type="password" name="password" required autocomplete="current-password" style="border-color: rgb(22, 234, 201); background-color: rgba(22, 234, 201, 0.1);">
                                @error('password')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="form-group d-flex justify-content-between align-items-center">
                                <button type="submit" class="btn btn-primary" style="background-color: rgb(22, 234, 201); border-color: rgb(22, 234, 201);">Iniciar sesión</button>                
                                <a href="" class="text-info">¿Olvidaste tu contraseña?</a>
                            </div>
                            <center><a href="{{ route('register') }}">¡Crea una cuenta!</a></center>
                        </form>
                    </div>
                </div>
            </div>
